  ...
  return (
    <button
      ...
      className={cn('py-3 px-9 text-sm font-display font-medium uppercase flex items-center', {
        ...
        'bg-[#060E11] hover:bg-[#060E11]/80 text-[#798894]': variant === 'tertiary' && !outlined,
        'bg-transparent border border-[#798894] enabled:hover:opacity-80 text-[#798894]': variant === 'tertiary' && outlined,
